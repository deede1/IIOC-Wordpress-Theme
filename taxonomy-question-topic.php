<?php get_header(); ?>
    ...
    <?php
        ...
        if( $breadcrumbs ){
    ?>
            <div class="mythemes-page-header taxonomy-header <?php echo esc_attr( $classes ); ?>">
    ...
    <div class="content main-content taxonomy-content">
        <div class="container">
            <div class="row">

                <?php get_template_part( 'templates/loop-taxonomy' ); ?>
